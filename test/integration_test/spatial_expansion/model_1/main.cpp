...
int main(int argc, char* argv[])
{
  ...
  auto is_temp_high = [temp](coord_type x, time_type){return temp(x, 0) >= 15 ? true : false ;};
  ...
  *  Sampling schemes
  **********************/
  std::cout << "6 ... Simulating sampling schemes" << std::endl;
  ...
  // Uniform sampling conditioned on population size
