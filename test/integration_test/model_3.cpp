...
int main(int argc, char *argv[])
{
    ...
    using simulator_type = quetzal::simulator::ForwardBackwardSpatiallyExplicit<coord_type, demographic_policy,
                                                                                coalescence_policy, memory_policy>;
    ...
    auto dispersal =
        demographic_policy::make_neighboring_migration(coord_type(), emigrant_rate, friction, get_neighbors);
    ...
    env.export_to_geotiff(
        N, t_0, sampling_time, [&simulator](time_type const &t) { return simulator.distribution_area(t); }, N_filename);
