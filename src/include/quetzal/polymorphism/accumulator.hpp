...
namespace boost::accumulators::impl
{
  ...
  class tajima_accumulator : accumulator_base
  {
  public:
    ///
    ...
    tajima_accumulator(Args const & args) : sum(args[sample | Sample()]) {}
    ...
    result_type result(Args const &args) const
    {
      ...
      return tajimasD(mean_pairwise_differences(args[accumulator]),
                      nb_segregating_site(args[accumulator]),
