...
namespace quetzal
{
	namespace coalescence
	{
		...
		{
			///
			/// @brief Collection of geo-localized coalescing trees.
			///
			/// @tparam Position Type of the geographic coordinate of the associated tree.
			/// @tparam Tree Type of the coalescence tree.
			///
			...
			private:
				...
				//! \typedef internal representation data type
				using data_type = std::unordered_multimap<Position, Tree>;
				//! \typedef size type of the container
				using size_type = typename data_type::size_type;
				data_type m_data;
			public:
				//! \typedef position type (usually geographic coordinates)
				using position_type = Position;
				//! \typedef iterator type for iterating along trees
