...
namespace quetzal::coalescence
{
  ...
  public:
    ...
    add_edges(vertex_descriptor parent, vertex_descriptor left, vertex_descriptor right)
    {
      ...
      return { add_left_edge(parent, left, _graph), add_right_edge(parent, right, _graph)};
    }
    ...
    vertex_descriptor
    root(vertex_descriptor u) const
    {
    ...
    /// @brief Performs a read&write depth-first traversal of the vertices in a directed graph
    ...
    /// @brief Performs a read-only depth-first traversal of the vertices in a directed graph
    /// @tparam DFSTreeVisitor
    /// @param s The vertex to start from
    /// @param vis The visitor to apply
    template <typename DFSTreeVisitor>
  ...
  /// @brief A binary tree class: primary template for partial specialization
  template <class VertexProperty, class EdgeProperty>
  class binary_tree
  {
  };
  ...
  public binary_tree_common<boost::no_property, boost::no_property>
  {
    using base = binary_tree_common<boost::no_property, boost::no_property>;
  ...
  public binary_tree_common<VertexProperty, boost::no_property>
  {
  private:
    using base = binary_tree_common<VertexProperty, boost::no_property>;
  ...
  public binary_tree_common<boost::no_property, EdgeProperty>
  {
  private:
    using base = binary_tree_common<boost::no_property, EdgeProperty>;
  ...
  public binary_tree_common<VertexProperty, EdgeProperty>
  {
  private:
    using base = binary_tree_common<VertexProperty, EdgeProperty>;
    detail::EdgeManager<typename base::edge_descriptor, EdgeProperty> _edge_manager;
    detail::VertexManager<typename base::vertex_descriptor, VertexProperty> _vertex_manager;
