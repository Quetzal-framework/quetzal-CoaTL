...
/*!
 * \brief Transforms <a
 * href="https://stackoverflow.com/documentation/c%2b%2b/7836/literals#t=201709240552046831589">literals</a> into
 * operator friendly classes
 *
 * Transforms a <a
 * href="https://stackoverflow.com/documentation/c%2b%2b/7836/literals#t=201709240552046831589">literal</a> object into
 * operator friendly class, allowing it to be composed into a more complex expression using mathematical operators with
 * others expressive objects having compatible callable interface.
 *
