...
namespace quetzal::geography::gdalcpp
{
    ...
    public:
        gdal_error(const std::string &message,
                   ...
                   const std::string &field = "") : std::runtime_error(message),
                                                    m_driver(driver),
                                                    m_dataset(dataset),
                                                    m_layer(layer),
                                                    m_field(field),
    ...
    namespace detail
    {
        ...
        public:
            Driver(const std::string &driver_name) : init_library(),
        ...
        struct Options
        {
            ...
            Options(const std::vector<std::string> &options) : m_options(options),
    ...
    public:
        //! Vector constructor
        Dataset(const std::string &driver_name, const std::string &dataset_name, const SRS &srs = SRS{}, const std::vector<std::string> &options = {}) : m_driver_name(driver_name),
        ...
        //! Raster constructor
        Dataset(const std::string &dataset_name, const SRS &srs = SRS{}, const std::vector<std::string> &options = {}) : m_driver_name(),
                                                                                                                         m_dataset_name(dataset_name),
                                                                                                                         m_options(options),
                                                                                                                         m_srs(srs),
    ...
    public:
        Layer(Dataset &dataset, const std::string &layer_name, OGRwkbGeometryType type, const std::vector<std::string> &options = {}) : m_options(options),
                                                                                                                                        m_dataset(dataset),
    ...
    public:
        Feature(Layer &layer, std::unique_ptr<OGRGeometry> &&geometry) : m_layer(layer),
