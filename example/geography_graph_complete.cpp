...
int main()
{
    ...
    auto graph1 = geo::from_grid(land, vertex_info(), edge_info(), geo::connect_fully(), geo::isotropy(),
                                 geo::mirror()); // dense, isotrope migration
    // auto graph2 = geo::from_grid( land, geo::connect_fully(), geo::anisotropy(), geo::mirror() ); // dense,
    // anisotrope

    // auto graph3 = geo::from_grid( land, geo::connect_4_neighbors(), geo::isotropy(), geo::mirror() ); // sparse,
    // isotrope migration auto graph4 = geo::from_grid( land, geo::connect_4_neighbors(), geo::anisotropy(),
    // geo::mirror() ); // sparse, anisotrope migration

    // auto graph5 = geo::from_grid( land, geo::connect_8_neighbors(), geo::isotropy(), geo::mirror() ); // sparse,
    // isotrope migration auto graph6 = geo::from_grid( land, geo::connect_8_neighbors(), geo::anisotropy(),
    // geo::mirror() ); // sparse, anisotrope migration
