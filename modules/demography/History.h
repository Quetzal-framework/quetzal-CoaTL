...
namespace demography {
  ...
  template<typename Space, typename Time, typename Value, typename Impl>
  class History;

  template<typename Space, typename Time>
  class History<Space, Time, unsigned int, quetzal::demography::PopulationFlux<Space, Time, unsigned int>>{
  ...
  template<typename Space, typename Time>
  class History<Space, Time, unsigned int, quetzal::demography::Flow<Space, Time, unsigned int>>{
