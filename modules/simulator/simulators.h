  ...
  namespace simulators {
    ...
    public:
      ...
      */
      ...
      void expand_demography(Growth growth, Dispersal kernel, time_type t_sampling, Generator& gen )
      {
    ...
    private:
      ...
      Forest migrate_backward(Forest & forest, time_type t, Generator& gen) const
      {
        Forest new_forest;
      ...
      void may_coalesce_colocated(forest_type<Tree>& forest, time_type const& t, Generator& gen, F binop) const
      {
        auto N = size_history();
