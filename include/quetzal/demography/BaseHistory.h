...
namespace quetzal
{
  ...
  {
    /*!
    * @brief Base class for population history. Encpasulates backward migration logic.
    *
    * @details CRTP design pattern: this class has to be specialized (inherited from)
    *          to define History classes with different behaviors (eg mass-based, individual-based, or storage).
    *
    ...
    */
    ...
    public:
      ...
      using pop_sizes_type = PopulationSize<Space, Time, typename dispersal_policy::value_type>;
      //! \typedef space type
