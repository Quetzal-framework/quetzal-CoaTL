...
namespace quetzal
{
	namespace fuzzy_transfer_distance
	{
		...
		public:
			...
			FuzzyPartition & merge_clusters(quetzal::fuzzy_transfer_distance::RestrictedGrowthString const& rgs)
			{
...
template<typename E>
std::ostream& operator<<(std::ostream& os, const quetzal::fuzzy_transfer_distance::FuzzyPartition<E>& fuzzy_partition)
{
